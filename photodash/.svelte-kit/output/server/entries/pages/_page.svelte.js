import { c as create_ssr_component, b as compute_rest_props, g as get_current_component, v as validate_component, t as each, r as escape } from "../../chunks/index3.js";
import { b as browser, S as Stack } from "../../chunks/Stack.js";
import { g as getHassAuth } from "../../chunks/apistore.js";
import { B as Box, u as useActions, A as AppShell } from "../../chunks/AppShell.js";
import { E as Error, B as Button } from "../../chunks/Button.js";
import { e as createStyles, b as createEventForwarder } from "../../chunks/stitches.config.js";
...
const Text = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Error, "Error").$$render($$result, { observable, component: "Text", code: err }, {}, {})}
...
${validate_component(Button, "Button").$$render($$result, { href: "/settings" }, {}, {
            default: () => {
              return `Settings`;
            }
          })}
        ...
        ${each(data.configurations, (config) => {
            return `${validate_component(Group$1, "Group").$$render($$result, { grow: true }, {}, {
              default: () => {
                ...
                ${validate_component(Button, "Button").$$render($$result, { href: `/${config.uid}` }, {}, {
                  default: () => {
                    return `Load`;
                  }
                })}
                ${validate_component(Button, "Button").$$render($$result, { href: `/config/${config.uid}` }, {}, {
                  default: () => {
                    return `Edit`;
                  }
                })}
...
${validate_component(Button, "Button").$$render($$result, { href: "/config" }, {}, {
            default: () => {
